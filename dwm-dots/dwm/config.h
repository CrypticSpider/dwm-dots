...
static const char *fonts[]                    = { "Hack:size=16","MesloLGS Nerd Font Mono:size=16", "NotoColorEmoji:pixelsize=16:antialias=true:autohint=true" };

/* Black Dark Theme */
static const char normbordercolor[] = "#000000";  // Black border color
static const char normbgcolor[]     = "#000000";  // Pure black background color
static const char normfgcolor[]     = "#aaaaaa";  // Light gray foreground color for visibility
static const char selbordercolor[]  = "#000000";  // Black selected border color
static const char selbgcolor[]      = "#000000";  // Same as normbgcolor (pure black) for selected background color
static const char selfgcolor[]      = "#aaaaaa";  // Light gray selected foreground color for visibility
...
static const char *const autostart[] = {
    ...
    "synergy", NULL,
    "dwmblocks", NULL,  // Start dwmblocks for status bar
    NULL /* terminate */
};
...
#define STATUSBAR "dwmblocks"  // Use dwmblocks for the status bar
/* commands */
